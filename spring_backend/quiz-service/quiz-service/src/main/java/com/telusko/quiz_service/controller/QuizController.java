...
import com.telusko.quiz_service.model.QuizResponse;
...
public class QuizController {
    ...
    @PostMapping("create")
    public ResponseEntity<QuizResponse> create(@RequestBody QuizDto quizDto) {
        return quizService.create(quizDto.getCategoryName(),quizDto.getNumQuestions(),quizDto.getTitle());
    }

    @GetMapping("get/{id}")
    public ResponseEntity<List<QuestionWarraper>> getQuizQuestion(@PathVariable Integer id) {
